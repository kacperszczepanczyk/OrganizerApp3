...
function validateName(event) {
    var $validationErrorDiv = $('fieldset#projectNameArea > div.validationError')
...
function validatePriority(event) {
    var $validationErrorDiv = $('fieldset#projectPriorityArea > div.validationError');
...
function validateExecutionTime(event) {
    var $validationErrorDiv = $('fieldset#projectExecutionTimeArea > div.validationError');
...
function validateStartTime(event) {
    var $validationErrorDiv = $('div#projectStartTimeArea').find('.validationError');
...
function setDateTimePickerVisibility() {
    ...
    if (value == "scheduled") {
        $('#projectStartTimeArea').show();
    }
    else {
        $('#projectStartTimeArea').hide();
    }
}
